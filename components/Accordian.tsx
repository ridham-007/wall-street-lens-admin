    ...
    <div className="border rounded mb-2">
      <div className="flex items-center justify-between bg-gray-200 p-2">
        ...
        <div className="flex items-center gap-[10px]">
          <button onClick={onDelete} className="text-blue-500 mr-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 48 48"
              width="24px"
          ...
          <button onClick={onEdit} className="text-red-500">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 30 30"
              width="24px"
      ...
      <div
        className={`max-h-0 overflow-hidden transition-max-h duration-100 ${
          isOpen ? "max-h-screen duration-200" : ""
        }`}
      >
