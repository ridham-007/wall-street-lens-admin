...
export function TD(props: { children?: JSX.Element | string, style?: string, onClick?:any }) {
  return <td onClick={props.onClick} className={`whitespace-nowrap text-[#6a7a8c] hover:text-[#000000]  p-3 border-collapse border-gray-300 border ${props.style ? props.style : "text-start"}`
  }> {props.children}</td >;
}
