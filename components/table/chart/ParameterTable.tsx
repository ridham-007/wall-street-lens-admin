import { Key, ReactNode, SetStateAction, useEffect, useRef, useState } from "react";
                                ...
                                <TD style="text-center">
                                    ...
                                    >
                                        <button
                                            ...
                                            onClick={() => { setUpdateChart(true); setCurrentData(current) }}
                                        >
                                        ...
                                        <button
                                            ...
                                            onClick={() => { setShowDelete(true); setDeleteId(current?.id?.toString() || ''); }}
                                        >
...
function UpdateChart(props: AddUpdateParameterProps) {
    ...
    const [selectedVariablesArr, setselectedVariablesArr] = useState<any[]>(selectedStates);
