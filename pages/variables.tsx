...
import { ADD_UPDATE_MASTER_VERIABLE, GET_COMPANIES, GET_INDUSTRIES, GET_MAPPING_VIEW, GET_SUB_INDUSTRIES, GET_TERMS_BY_COMPANY, GET_VARIBALES_KPI_TERM } from "@/utils/query";
